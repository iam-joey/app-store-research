...
Downloads, revenue, retention, daily users, keyword popularity, star ratings without text, version history before the current release. Say so plainly when asked.
